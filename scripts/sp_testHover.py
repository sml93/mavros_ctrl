...
def setpoint_demo():
    ...
    # for i in range(3):
    #     count = 3 - i
    #     print('jetting in', count)
    # print("Jetting now")
    # # start_time = time.time()
    # ## TODO: To add in jetting command
    # jetswitch = np.int16(180)                  # Uncomment these two if you still wish to jet remotely
    # jetpub.publish(jetswitch)                  # Uncomment these two if you still wish to jet remotely
    #
    # setpoint.set(2.0 + 1.0, 0.5, 1.5 - 0.05, 0)
    # time.sleep(10)
