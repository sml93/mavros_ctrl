...
class MavrosOffboardPosCtlTest(MavrosTestCommon):
    ...
    def send_pos(self):
        ...
        while not rospy.is_shutdown():
            # # Optional
            # self.pos.pose.position.x = self.x
            # self.pos.pose.position.y = self.y
            # self.pos.pose.position.z = self.z

            # Lock yaw/heading to north (demo purposes)
            yaw_degrees = 0
